...
// ValidateForCreate validates the car before creation.
//
// It ensures that the ID is empty (since it is generated by the system)
// and that all required fields contain valid values.
